        ...
        <Row className="justify-content-center">
          <Col lg={10}>
            ...
            <div className="d-flex align-items-start gap-3 mb-4">
              ...
              <div>
                <h5 className="fw-bold mb-2">
                  <Link href="/vendors" className="text-success fw-semibold text-decoration-none deep-link">
                    Explore Vendors
                  </Link>
                </h5>
                <p className="text-muted mb-0">
            ...
            <div className="d-flex align-items-start gap-3 mb-4">
              ...
              <div>
                <h5 className="fw-bold mb-2">
                  <Link href="/favorites" className="text-success fw-semibold text-decoration-none deep-link">
                    Save Your Favorites
                  </Link>
                </h5>
                <p className="text-muted mb-0">
